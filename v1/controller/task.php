...
// get all tasks api/vi/tasks
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        try {
            ...
            $query = $writeDB->prepare('INSERT INTO tbltasks (title, description, deadline, completed) VALUES (:title, :description, STR_TO_DATE(:deadline, "%d/%m/%Y %H:%i"), :completed) WHERE userid = :userid');
